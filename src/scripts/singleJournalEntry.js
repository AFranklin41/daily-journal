        ...
        <!-- Blog entries -->
            ...
            <div class="w3-container">
                    ...
                    <div class="w3-container">
                        ...
                        <p><b><button id="details-button-${journalEntryObject.id}" class="w3-button w3-padding-large w3-white w3-border">Details »</button></b></p>

                        <p><b><button class="w3-button w3-padding-large w3-white w3-border" id="delete-entry-${journalEntryObject.id}">
                        Delete
                           </button><b></p>
